package com.sdia.kafkaelasticservice.consumer.impl;
...
import com.sdia.kafkaelasticservice.consumer.KafkaConsumer;
...
@Service
@ComponentScan(basePackages = {"com.sdia.appconfigdata.config","com.sdia.kafkaadmin.client"})
